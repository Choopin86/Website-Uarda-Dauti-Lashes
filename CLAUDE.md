...
- **Current resume point:** `transformAboutBio.js` — completed, moving to section 3: Achievements (reuse existing `transformAchievements`/`renderAchievements` from the homepage as-is).
